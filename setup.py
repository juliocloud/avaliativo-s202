...
def setup_database():
    ...
    todas_queries = professores + escolas + localidades + relacoes_professor_escola + relacoes_escola_cidade + relacoes_cidade_estado
